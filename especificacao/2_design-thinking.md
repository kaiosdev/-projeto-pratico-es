...
A **Análise SWOT** (ou FOFA) é utilizada para avaliar a situação do aplicativo, considerando fatores internos (Forças e Fraquezas) e externos (Oportunidades e Ameaças) que impactam o sucesso do projeto.
...
* **Fraquezas (Weaknesses):**
    ...
    - Desafio técnico de manter recursos de análise avançada sem conexão.
...
* **Ameaças (Threats):**
    ...
    - Riscos de privacidade em relação a dados sensíveis de saúde.
