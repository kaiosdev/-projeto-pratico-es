...
A documentação técnica do projeto está organizada na pasta `especificacao/`, seguindo os padrões da disciplina:

| Arquivo | Descrição |
| :--- | :--- |
| [`1_plano-de-trabalho.md`](/blob/main/especificacao/1_plano_de_trabalho.md)) | Escopo, tecnologias e divisão de papéis da equipe. |
| [`2_design-thinking.md`](/main/especificacao/2_design-thinking.md) | Golden Circle, Análise SWOT, Personas e Ideação. |
